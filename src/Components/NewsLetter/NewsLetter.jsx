...
const NewsLetter = () => {
  return (
    <div className='newsletter w-[85%] h-[40vh] flex flex-col items-center justify-center m-auto py-0 px-[140px]  mb-[150px] bg-gradient-to-t from-[#fde1ff]/0 to-[#e1ffea22]/60 gap-[30px]' >
